...
function createMockPage({ missing = [], forcedValues = {} } = {}) {
  ...
  const selectorMap = {
    ...
    "xpath=(//*[normalize-space(.)='Kilometerangabe']/following::*[normalize-space(.)='Abfahrtsort']/following::input[not(@type='hidden') and not(@aria-hidden='true') and not(contains(@class,'tt-hint'))])[1]": "mileageFromInput",
    "input[name='mileageTo']": "mileageToInput",
    "xpath=(//*[normalize-space(.)='Kilometerangabe']/following::*[normalize-space(.)='Zielort']/following::input[not(@type='hidden') and not(@aria-hidden='true') and not(contains(@class,'tt-hint'))])[1]": "mileageToInput",
