...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    private func disableScrollIndicators() {
        ...
        disableScrollIndicatorsRecursively(in: rootView)
    }

    private func disableScrollIndicatorsRecursively(in view: UIView) {
        ...
        for child in view.subviews {
            disableScrollIndicatorsRecursively(in: child)
        }
    }
